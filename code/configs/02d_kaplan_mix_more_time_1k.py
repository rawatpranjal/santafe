# 02d_kaplan_mix_more_time_1k.py
# Kaplan performance replication - More Time (5B/5S, 4T, 50S)
...
STEPS_PER_PERIOD = 50 # CHANGED: More steps per period
NUM_PERIODS = 3

# --- CONFIG Dictionary ---
CONFIG = {
    # --- Experiment Identification ---
    "experiment_name": "02d_kaplan_mix_more_time_1k", # Will be overridden by runner
    "experiment_dir": "experiments",

    # --- Auction Settings ---
    "num_rounds": TOTAL_ROUNDS,
    "num_periods": NUM_PERIODS,
    "num_steps": STEPS_PER_PERIOD, # Uses updated value
