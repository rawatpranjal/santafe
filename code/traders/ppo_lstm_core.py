...
class PPOLogicLSTM:
    def __init__(self, state_dim, action_dim, config, seed):
        ...
        self.ent_coef = float(params.get('entropy_coef', 0.01))
        self.vf_coef = float(params.get('vf_coef', 0.5))
        self.learning_rate = float(params.get('lr', 3e-4))
        self.update_epochs = int(params.get('update_epochs', 4))
        ...
        self.minibatch_size = int(params.get('minibatch_size', 0)) # 0 means use full trajectory
